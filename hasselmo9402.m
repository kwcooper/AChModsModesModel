...
for trl = 1:p.nTrls
  ...
  if plt, plotStateVariables(theta,a,pha,syn,stage); end % TD: make plot parameter
end
...
function plotStateVariables(theta,a,pha,syn,stage)
    figure;
    subplot(6,1,1);
    ...
    title(['End of training', num2str(stage)]);
