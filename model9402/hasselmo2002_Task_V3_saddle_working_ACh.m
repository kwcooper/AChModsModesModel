function hasselmo2002_Task_V3_saddle_working_ACh()
...
if verbose figure; plotStateVariables(theta,a,'Error Reversal'); end
%% Phase Three
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%         Reversal training             %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for trl = 1:p.nTrls_rev
  ...
  if verbose figure; plotStateVariables(theta,a,'Reversal'); end
...
if verbose figure; plotStateVariables(theta,a,'Correct Reversal'); end
...
function [a,tempXprod, ph, theta] = runTheta(a,tempXprod,w,p,EC_TP,CA3_TP,stage)
  ...
  %TODO: This needs to be passes as a variable? 
  % initialize ACh levels and phases
  AchPut = linspace(-10,10,p.nTSteps*p.stepsPerCycle); % changed p.nCycles to nTSteps
